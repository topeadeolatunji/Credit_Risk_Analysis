...
## Overview
The purpose of this analysis is to understand how to utilize Machine Learning statistical algorithms to make predictions based on data patterns provided. I focus on supervised learning using a free dataset from LendingClub, a peer-to-peer lending services company to evaluate and predict the credit risk of its loans. This reason why this is called "supervised learning" is because the data includes a labeled outcome.
